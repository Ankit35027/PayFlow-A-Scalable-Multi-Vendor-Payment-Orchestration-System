...
/**
 * ┌─────────────────────────────────────────────────────────────────┐
 * │ TestCases.ts — Automated Test Suite for PayFlow                │
 * │                                                                │
 * │ Covers all 7 core functionalities + OOP/SOLID/Design Patterns  │
 * │ Run with: npx ts-node src/TestCases.ts                         │
 * └─────────────────────────────────────────────────────────────────┘
 */
...
function testUserRegistrationAndLogin(): void {
    ...
    // TC-1.1: Create a new user with valid details
    ...
    // TC-1.2: Verify all encapsulated fields via getters
...
function testUPIPayment(): void {
    ...
    // TC-3.2: UPI payment — insufficient balance
    suppressLogs();
    ...
    // TC-3.3: UPI payment — invalid receiver account
    suppressLogs();
    ...
    // TC-3.4: UPI payment — invalid sender account
    suppressLogs();
    ...
    // TC-3.5: Verify transaction type is UPI
...
// ═══════════════════════════════════════════════════════════════════
// ── TEST SUITE 4: Send Money — Net Banking ──────────────────────────
// ═══════════════════════════════════════════════════════════════════
...
function testNetBankingPayment(): void {
    ...
    // TC-4.1: Successful Net Banking payment
    suppressLogs();
    ...
    // TC-4.2: Verify transaction type is NETBANKING
    ...
    // TC-4.3: Net Banking with insufficient balance
    suppressLogs();
...
// ═══════════════════════════════════════════════════════════════════
// ── TEST SUITE 5: View Transaction History ──────────────────────────
// ═══════════════════════════════════════════════════════════════════
...
function testTransactionHistory(): void {
    ...
    // TC-5.3: Correct transaction in history
...
// ═══════════════════════════════════════════════════════════════════
// ── TEST SUITE 6: Cancel Transaction ────────────────────────────────
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// ── TEST SUITE 7: Transaction Status Lookup ─────────────────────────
// ═══════════════════════════════════════════════════════════════════
...
function testOOPConcepts(): void {
    ...
    // TC-9.3: processPayment() behaves differently for UPI vs NetBanking
    suppressLogs();
    ...
    // Both called through same reference type, different behavior
...
// ═══════════════════════════════════════════════════════════════════
// ── TEST SUITE 10: BankAPI Operations ───────────────────────────────
// ═══════════════════════════════════════════════════════════════════
...
function runAllTests(): void {
    ...
    testUserRegistrationAndLogin();   // Suite 1: Register & Login
    testCheckBalance();               // Suite 2: Check Balance
    testUPIPayment();                 // Suite 3: Send Money (UPI)
    testNetBankingPayment();          // Suite 4: Send Money (Net Banking)
    testTransactionHistory();         // Suite 5: View Transaction History
    testCancelTransaction();          // Suite 6: Cancel Transaction
    testTransactionStatus();          // Suite 7: Check Transaction Status
    testDesignPatterns();             // Suite 8: Singleton + Factory
    testOOPConcepts();                // Suite 9: OOP Concepts
    testBankAPI();                    // Suite 10: BankAPI Operations
